...
class Actor:
    ...
    def update_network_parameters(self, tau=None):
        ...
        weights = []
        targets = self.target_actor_net.weights
        ...
        weights = []
        targets = self.target_critic_net.weights
    ...
    def learn(self):
        if self.replayMemory.mem_cntr < self.batch_size:
            return
        
        state, action, reward, new_state, done = \
            self.replayMemory.sample_buffer(self.batch_size)
